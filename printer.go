...
// printFile is the entry action. It is a stub that prints nothing for the
// empty (zero-value) *File. The implementer dispatches into the division
// printers here, each via its own inner action loop (see CLAUDE.md).
